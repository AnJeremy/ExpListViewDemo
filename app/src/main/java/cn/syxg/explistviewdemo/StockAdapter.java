    ...
    protected void convert(BaseViewHolder holder, StockEntity.StockInfo item) {
        switch (holder.getItemViewType()) {
            ...
            case StockEntity.StockInfo.TYPE_HEADER:
                ...
                //holder.addOnClickListener(R.id.tv_stock_name);
            ...
            case StockEntity.StockInfo.TYPE_DATA:
                ...
                ssb.setSpan(new AbsoluteSizeSpan(TestFragment.dip2px(holder.itemView.getContext(), 13)), item.stock_name.length(), stockNameAndCode.length(),
                        Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                ...
                //holder.addOnClickListener(R.id.tv_stock_name_code);
                break;
