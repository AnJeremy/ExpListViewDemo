...
public class SicketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sicket);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPreExecute() {
                ...
                mRecyclerView.setLayoutManager(new LinearLayoutManager(SicketActivity.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    public void onHeaderClick(View view, int id, int position) {
                        switch (id) {
                            case R.id.fl:
                                ...
                                Toast.makeText(SicketActivity.this, "click, tag: " + mAdapter.getData().get(position).pinnedHeaderName, Toast.LENGTH_SHORT).show();
                                break;
                            case R.id.iv_more:
                                Toast.makeText(SicketActivity.this, "click " + mAdapter.getData().get(position).pinnedHeaderName + "'s more button", Toast.LENGTH_SHORT)
                                        .show();
                                break;
                            case R.id.checkbox:
            ...
            protected void onPostExecute(String result) {
                ...
                mAdapter.addHeaderView(LayoutInflater.from(SicketActivity.this).inflate(R.layout.item_data, mRecyclerView, false));
