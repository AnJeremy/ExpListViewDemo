...
public class MyAdapter extends BaseExpandableListAdapter implements CustomExpandListview.HeaderAdapter {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView tv_m = (TextView) view.findViewById(R.id.tv_parent_m);
        TextView tv_y = (TextView) view.findViewById(R.id.tv_parent_y);
        TextView tv_mon = (TextView) view.findViewById(R.id.tv_parent_mon);
        tv_m.setText(parent.get(i));
        return view;
    }
    ...
    public void configureHeader(View header, int groupPosition, int childPosition, int alpha) {
        if (groupPosition > -1) {
            ((TextView) header.findViewById(R.id.tv_parent_m))
